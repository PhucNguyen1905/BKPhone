                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item p-2">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-white fw-bold overflow-hidden w-100"
                                        style="line-height: 1.5em; height: 3em;"><?php echo $item['name'] ?></h5>
                                    <p class="price mb-0">
                                        <?php echo number_format($item['final_price'], 0, ',', '.') . ' VNĐ' ?></p>
                                </div>
                                <div class="card-footer">
                                    <a href="/BKPhone/ProductDetail/viewProduct/<?= $item['id'] ?>"
                                        class="btn btn-outline-warning">Mua ngay</a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
...
<div class="up-btn rounded">
    <a href="#header">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ffc107" class="bi bi-arrow-up-square-fill"
            viewBox="0 0 16 16">
            <path
