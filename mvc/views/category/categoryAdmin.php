...
<div class="row" style="margin-top: 20px;">
	...
	<div class="col-md-6">
		<form method="post" action="http://localhost/BKPhone/CategoryAdmin/insertCategoryController">
		...
		<table class="table table-bordered table-hover" style="margin-top: 20px;">
			...
			<tbody>
				...
				for ($i = 0; $i < $countCategory; $i++) {
					...
					<td style="width: 50px">
						<a href="http://localhost/BKPhone/CategoryAdmin/updateCategoryController/' . $data["category"][$i]["id"] . '"><button class="btn btn-warning">Sửa</button></a>
					</td>
					<td style="width: 50px">
					<a href="http://localhost/BKPhone/CategoryAdmin/deleteCategoryController/' . $data["category"][$i]["id"] . '"><button class="btn btn-danger">Xóa</button></a>
					</td>
				</tr>';
				}
