...
<body>
    ...
    <nav id="navColor" class=" navbar fixed-top navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="http://localhost/BKPhone/Home"><img src="http://localhost/BKPhone/public/logophonestore.svg" alt="G.I.Joe"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item <?php if ($data["render"] != "tintuc" && $data["render"] != "gioithieu" && $data["render"] != "contact") echo "active"; ?>">
                    <a class="nav-link" href="http://localhost/BKPhone/Home">Trang chủ <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="http://localhost/BKPhone/Home/productList" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Sản phẩm
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="http://localhost/BKPhone/Home/productList/0">Tất cả</a>
                        <?php
                        $countCategory = count($data["allCategory"]);
                        for ($i = 0; $i < $countCategory; $i++) {
                            echo   '<a class="dropdown-item" href="http://localhost/BKPhone/Home/productList/' . $data["allCategory"][$i]["id"] . '">' . $data["allCategory"][$i]["name"] . '</a>';
                        }
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if ($data["render"] == "tintuc") echo "active"; ?>" href="http://localhost/BKPhone/Home/tintuc">Tin tức</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($data["render"] == "gioithieu") echo "active"; ?>" href="http://localhost/BKPhone/Home/gioithieu">Giới thiệu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($data["render"] == "contact") echo "active"; ?>" href="http://localhost/BKPhone/Home/contact">Liên hệ</a>
                </li>
            </ul>
        ...
        <div class="shopping_cart">
            <a style="font-size: 30px;color:black" href="http://localhost/BKPhone/Home/card"><i class="shopping_cart fas fa-shopping-cart"></i></a>
