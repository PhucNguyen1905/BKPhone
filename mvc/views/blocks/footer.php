        ...
        <div class="row mt-1 mt-md-0 mb-4 mb-md-0">
            ...
            <div class="col-md-3 mx-auto mt-3 mt-md-0 mb-0 mb-md-4">
                ...
                <ul class="list-unstyled foot-desc">
                    <li class="mb-2">
                        <a href="http://localhost/BKPhone/Home/productList/1">Vsmart</a>
                    </li>
                    <li class="mb-2">
                        <a href="http://localhost/BKPhone/Home/productList/2">Iphone</a>
                    </li>
                    <li class="mb-2">
                        <a href="http://localhost/BKPhone/Home/productList/3">Samsung</a>
                    </li>
                    <li class="mb-2">
                        <a href="http://localhost/BKPhone/Home/productList/104">Oppo</a>
                    </li>
                </ul>
