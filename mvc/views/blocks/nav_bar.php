        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end float-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item m-1">
                        <a class="nav-link text-warning fw-bold <?php echo $activeNav == "cart" ? "nav-link-active" : ""?>" href="http://localhost/BKPhone/Home/card"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
