    ...
    <?php
        $countBrand = count($data["allBrand"]);
            for($i=0;$i<$countBrand;$i++){
                echo   '<button style="margin-bottom: 5px; margin-right: 5px;';if($data["category_id"] == $data["allBrand"][$i]["id"]) echo "background-color:red"; echo '" type="button" class="btn btn-primary">
