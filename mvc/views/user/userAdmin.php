...
<div class="container-fluid px-4">
	...
	<a href="http://localhost/BKPhone/UserAdmin/viewInsertUser" class="btn btn-outline-primary">Add New Account</a>
	<div class="row mt-3">
				...
				<tbody>
					...
					foreach ($data["allUser"] as $user) { ?>
						<tr>
							...
							<td><a href="<?php echo 'http://localhost/BKPhone/UserAdmin/viewUpdateUser/' . $user['id']; ?>" class="editLink">Edit</a></td>
